...
def mean_average_precision(
    pred_boxes, true_boxes, iou_threshold=0.5, box_format="midpoint", num_classes=NUM_CLASSES
):
    """
...
def convert_cellboxes(predictions, S=7):
    ...
    predictions = predictions.reshape(batch_size, 7, 7, NUM_CLASSES+10)
    bboxes1 = predictions[..., (NUM_CLASSES+1):(NUM_CLASSES+5)]
    bboxes2 = predictions[..., (NUM_CLASSES+1+5):(NUM_CLASSES+5+5)]
    scores = torch.cat(
